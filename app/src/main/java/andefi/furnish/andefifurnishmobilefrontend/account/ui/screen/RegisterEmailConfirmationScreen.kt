...
@Composable
fun RegisterEmailConfirmationScreen() {
    Scaffold(
        topBar = {
            Column {
                TopAppBar(
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            Column(
                ...
                Column(
                    ...
                    Text(
                        "Tautan konfirmasi telah dikirimkan ke email Anda a****y@gmail.com. Mohon klik tautan tersebut untuk memverifikasi alamat email Anda dan menyelesaikan proses pendaftaran.",
                        fontFamily = RobotoFamily,
                        fontWeight = FontWeight.Normal,
                        fontSize = 16.sp
                    )
